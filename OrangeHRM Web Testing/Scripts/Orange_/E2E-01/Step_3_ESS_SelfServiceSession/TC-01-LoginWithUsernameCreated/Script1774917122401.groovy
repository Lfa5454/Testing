...
if (!(GlobalVariable.loginDone)) {
    CustomKeywords.'login.LoginKeywords.login'(GlobalVariable.username, GlobalVariable.pass)
...
WebUI.verifyElementVisible(findTestObject('Page_OrangeHRM/Login/header_Dashboard'))
