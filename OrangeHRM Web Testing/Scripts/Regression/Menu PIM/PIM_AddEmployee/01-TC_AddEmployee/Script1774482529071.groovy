...
addEmployee.verifyNotification("usernamealreadyexists")
addEmployee.saveEmployee()

// Assert : Redirect to Personal Details page
addEmployee.verifyNotification("save")
addEmployee.verifyNotification("personaldetails")