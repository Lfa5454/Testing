...
recruitmentPage.selectOption("hiringmanager_input","Ranga  Akunuri")
recruitmentPage.selectOption("position_input","1")
recruitmentPage.selectOption("active_checkbox","")
